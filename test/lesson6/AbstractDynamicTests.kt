...
Наследник всех своих родных.
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(14, shortestPathOnField("input/field_in4.txt"))
        assertEquals(35, shortestPathOnField("input/field_in5.txt"))
        assertEquals(38, shortestPathOnField("input/field_in6.txt"))
    }
